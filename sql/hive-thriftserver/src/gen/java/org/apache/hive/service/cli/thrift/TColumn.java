...
public class TColumn extends org.apache.thrift.TUnion<TColumn, TColumn._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.I64_VAL, new org.apache.thrift.meta_data.FieldMetaData("i64Val", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.hive.service.cli.thrift.TI64Column.class)));
    tmpMap.put(_Fields.DOUBLE_VAL, new org.apache.thrift.meta_data.FieldMetaData("doubleVal", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.hive.service.cli.thrift.TDoubleColumn.class)));
    tmpMap.put(_Fields.STRING_VAL, new org.apache.thrift.meta_data.FieldMetaData("stringVal", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.hive.service.cli.thrift.TStringColumn.class)));
    tmpMap.put(_Fields.BINARY_VAL, new org.apache.thrift.meta_data.FieldMetaData("binaryVal", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.hive.service.cli.thrift.TBinaryColumn.class)));
  ...
  public static TColumn i64Val(org.apache.hive.service.cli.thrift.TI64Column value) {
    TColumn x = new TColumn();
    x.setI64Val(value);
    return x;
  }

  public static TColumn doubleVal(org.apache.hive.service.cli.thrift.TDoubleColumn value) {
    TColumn x = new TColumn();
    x.setDoubleVal(value);
    return x;
  }

  public static TColumn stringVal(org.apache.hive.service.cli.thrift.TStringColumn value) {
    TColumn x = new TColumn();
    x.setStringVal(value);
    return x;
  }

  public static TColumn binaryVal(org.apache.hive.service.cli.thrift.TBinaryColumn value) {
    TColumn x = new TColumn();
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case I64_VAL:
        if (value instanceof org.apache.hive.service.cli.thrift.TI64Column) {
          break;
        }
      ...
      case DOUBLE_VAL:
        if (value instanceof org.apache.hive.service.cli.thrift.TDoubleColumn) {
          break;
        }
      ...
      case STRING_VAL:
        if (value instanceof org.apache.hive.service.cli.thrift.TStringColumn) {
          break;
        }
      ...
      case BINARY_VAL:
        if (value instanceof org.apache.hive.service.cli.thrift.TBinaryColumn) {
          break;
        }
      ...
      switch (setField) {
        ...
        case I64_VAL:
          if (field.type == I64_VAL_FIELD_DESC.type) {
            org.apache.hive.service.cli.thrift.TI64Column i64Val;
            i64Val = new org.apache.hive.service.cli.thrift.TI64Column();
            i64Val.read(iprot);
            return i64Val;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
        ...
        case DOUBLE_VAL:
          if (field.type == DOUBLE_VAL_FIELD_DESC.type) {
            org.apache.hive.service.cli.thrift.TDoubleColumn doubleVal;
            doubleVal = new org.apache.hive.service.cli.thrift.TDoubleColumn();
        ...
        case STRING_VAL:
          if (field.type == STRING_VAL_FIELD_DESC.type) {
            org.apache.hive.service.cli.thrift.TStringColumn stringVal;
            stringVal = new org.apache.hive.service.cli.thrift.TStringColumn();
        ...
        case BINARY_VAL:
          if (field.type == BINARY_VAL_FIELD_DESC.type) {
            org.apache.hive.service.cli.thrift.TBinaryColumn binaryVal;
            binaryVal = new org.apache.hive.service.cli.thrift.TBinaryColumn();
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case I32_VAL:
        ...
        return;
      case I64_VAL:
        org.apache.hive.service.cli.thrift.TI64Column i64Val = (org.apache.hive.service.cli.thrift.TI64Column)value_;
        i64Val.write(oprot);
        return;
      case DOUBLE_VAL:
        org.apache.hive.service.cli.thrift.TDoubleColumn doubleVal = (org.apache.hive.service.cli.thrift.TDoubleColumn)value_;
        doubleVal.write(oprot);
        return;
      case STRING_VAL:
        org.apache.hive.service.cli.thrift.TStringColumn stringVal = (org.apache.hive.service.cli.thrift.TStringColumn)value_;
        stringVal.write(oprot);
        return;
      case BINARY_VAL:
        org.apache.hive.service.cli.thrift.TBinaryColumn binaryVal = (org.apache.hive.service.cli.thrift.TBinaryColumn)value_;
  ...
  public org.apache.hive.service.cli.thrift.TI64Column getI64Val() {
    if (getSetField() == _Fields.I64_VAL) {
      return (org.apache.hive.service.cli.thrift.TI64Column)getFieldValue();
    } else {
  ...
  public org.apache.hive.service.cli.thrift.TDoubleColumn getDoubleVal() {
    if (getSetField() == _Fields.DOUBLE_VAL) {
      return (org.apache.hive.service.cli.thrift.TDoubleColumn)getFieldValue();
    } else {
  ...
  public org.apache.hive.service.cli.thrift.TStringColumn getStringVal() {
    if (getSetField() == _Fields.STRING_VAL) {
      return (org.apache.hive.service.cli.thrift.TStringColumn)getFieldValue();
    } else {
  ...
  public org.apache.hive.service.cli.thrift.TBinaryColumn getBinaryVal() {
    if (getSetField() == _Fields.BINARY_VAL) {
      return (org.apache.hive.service.cli.thrift.TBinaryColumn)getFieldValue();
    } else {
