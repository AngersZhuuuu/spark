...
public class TTypeQualifiers implements org.apache.thrift.TBase<TTypeQualifiers, TTypeQualifiers._Fields>, java.io.Serializable, Cloneable, Comparable<TTypeQualifiers> {
  ...
  private Map<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> qualifiers; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.QUALIFIERS, new org.apache.thrift.meta_data.FieldMetaData("qualifiers", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            ...
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.hive.service.cli.thrift.TTypeQualifierValue.class))));
  ...
  public TTypeQualifiers(
    Map<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> qualifiers)
  {
    this();
  ...
  public TTypeQualifiers(TTypeQualifiers other) {
    if (other.isSetQualifiers()) {
      Map<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> __this__qualifiers = new HashMap<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue>(other.qualifiers.size());
      for (Map.Entry<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> other_element : other.qualifiers.entrySet()) {

        String other_element_key = other_element.getKey();
        org.apache.hive.service.cli.thrift.TTypeQualifierValue other_element_value = other_element.getValue();

        String __this__qualifiers_copy_key = other_element_key;

        org.apache.hive.service.cli.thrift.TTypeQualifierValue __this__qualifiers_copy_value = new org.apache.hive.service.cli.thrift.TTypeQualifierValue(other_element_value);
  ...
  public void putToQualifiers(String key, org.apache.hive.service.cli.thrift.TTypeQualifierValue val) {
    if (this.qualifiers == null) {
      this.qualifiers = new HashMap<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue>();
    }
    this.qualifiers.put(key, val);
  }

  public Map<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> getQualifiers() {
    return this.qualifiers;
  }

  public void setQualifiers(Map<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> qualifiers) {
    this.qualifiers = qualifiers;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case QUALIFIERS:
      if (value == null) {
        ...
        setQualifiers((Map<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.qualifiers = new HashMap<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue>(2*_map0.size);
                String _key1;
                org.apache.hive.service.cli.thrift.TTypeQualifierValue _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  _key1 = iprot.readString();
                  _val2 = new org.apache.hive.service.cli.thrift.TTypeQualifierValue();
                  _val2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTypeQualifiers struct) throws org.apache.thrift.TException {
      ...
      if (struct.qualifiers != null) {
        oprot.writeFieldBegin(QUALIFIERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> _iter4 : struct.qualifiers.entrySet())
          {
  ...
  private static class TTypeQualifiersTupleScheme extends TupleScheme<TTypeQualifiers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TTypeQualifiers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue> _iter5 : struct.qualifiers.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTypeQualifiers struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.qualifiers = new HashMap<String, org.apache.hive.service.cli.thrift.TTypeQualifierValue>(2*_map6.size);
        String _key7;
        org.apache.hive.service.cli.thrift.TTypeQualifierValue _val8;
