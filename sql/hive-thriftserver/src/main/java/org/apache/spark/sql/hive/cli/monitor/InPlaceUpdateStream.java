...
public interface InPlaceUpdateStream {
  ...
  InPlaceUpdateStream.EventNotifier getEventNotifier();

  class EventNotifier {
    public static final Logger LOG = LoggerFactory.getLogger(org.apache.hive.jdbc.logs.InPlaceUpdateStream.EventNotifier.class.getName());
